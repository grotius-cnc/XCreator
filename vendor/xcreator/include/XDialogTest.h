#ifndef XDIALOGTEST_H
#define XDIALOGTEST_H
...
class XDialogTest: public XWidget {
public:
    XDialogTest(){
        init();
    }
    ...
    void init(){
        ...
        myTemplate->setSize({{0,0,0},100,100});
        myTemplate->init();
        addWidget(myTemplate);
    ...
    void draw(){
        ...
        myTemplate->setSize(mySize->Size());
