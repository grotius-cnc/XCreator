#ifndef XDIALOGFILEOPEN_H
#define XDIALOGFILEOPEN_H
...
#include <XWidget.h>
#include <XDialogFileContent.h>

//! Open a file dialog.
class XDialogFileOpen: public XWidget {
public:
    XDialogFileOpen(){
        init();
    }
    ...
    void init(){
        std::cout<<"Dialog File init"<<std::endl;
        ...
        this->setName("Dialog File Chooser");
        ...
        myContent=new XDialogFileContent(Window());
    ...
    std::string Result(){
        return myContent->Result();
    }
private:
    GLFWwindow* window;
    int myWidth=600, myHeight=300;
    XSize *mySize=new XSize();
    XDialogFileContent *myContent;
};
#endif
