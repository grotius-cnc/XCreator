#ifndef XRECTANGULAR_H
#define XRECTANGULAR_H
...
class XRectangular : public XWidget {
public:
    //! Empty destructor.
    XRectangular(){
        init();
    ...
    XRectangular(XWindow *theWindow){
    ...
    *myColor=new XColor(0.1,0.1,0.1,0.9);
    ...
    void drawGL(){
        ...
        float vertices[] = {
            ...
            mySize->UpperRight().X()+mySize->RelativeOriginOffset().X(), this->Window()->Height()-(mySize->UpperRight().Y()+mySize->RelativeOriginOffset().Y()), mySize->UpperRight().Z()+mySize->RelativeOriginOffset().Z(),
            mySize->LowerRight().X()+mySize->RelativeOriginOffset().X(), this->Window()->Height()-(mySize->LowerRight().Y()+mySize->RelativeOriginOffset().Y()), mySize->LowerRight().Z()+mySize->RelativeOriginOffset().Z(),
            mySize->LowerLeft().X()+mySize->RelativeOriginOffset().X(), this->Window()->Height()-(mySize->LowerLeft().Y()+mySize->RelativeOriginOffset().Y()), mySize->LowerLeft().Z()+mySize->RelativeOriginOffset().Z(),
            mySize->Origin().X()+mySize->RelativeOriginOffset().X(), this->Window()->Height()-(mySize->Origin().Y()+mySize->RelativeOriginOffset().Y()), mySize->Origin().Z()+mySize->RelativeOriginOffset().Z()
        };
        uint indices[] = {
